...
namespace AndrzejRental.RentalUtils
{
    internal class UserRental
    {
        ...
        public List<string> GetRentedMovieList(IUser user)
        {
            List<string> rentedMovieList = new List<string>();
            foreach (IMovie movie in user.GetCollection())
            {
                rentedMovieList.Add(movie.GetTitle());
            }
